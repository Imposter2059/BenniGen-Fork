...
print("""Benni Gen Forked Edition v1.11""")
print("        Small Patch Update       ")
time.sleep(0.2)

print("Enter: 'A' to go to the Credits.")
print("Enter: 'B' to go to the Tutorial")
print("Enter: 'C' to go to the Tips.")
print("Enter: 'D' to go to the Changelog.")
print("Enter: 'E' to go to the Version display")
...
if user_input == "A":
    ...
    print("-Added Version display")
    print("-Added auto-fullscreen")
    print("-Added deppresion towards the dev")
    print("-Cleaned up internal code")
    print("-Fixed Version number")
    print("")
    time.sleep(1)
    special_option_selected = True
    print("This window will automatically close in 40 seconds.")
    ...
    print("Model Version -:- v1.11(.0)")
    print("-Standard Edition")
    print("Advanced Version ID -:- v1.11.0-Stable")
    print("NOTE -:- !!!SUPPORT ON PLATFORMS OTHER THAN WINDOWS IS NOT GUARANTEED!!!")
    time.sleep(1)
    special_option_selected = True
    print("This window will automatically close in 120 seconds.")
    time.sleep(120)
    exit()
